    ...
    'form' => [
        ...
        'other' => [
            ...
            'fields' => [
                ...
                'button.item.transition' => [
                    'label' => 'Item Transition color',
                    'type' => 'colorpicker',
                    'span' => 'right',
                    'default' => '#232227',
                    'rules' => 'required',
                    'assetVar' => 'item-transition-color',
                ],
                'button.item.border' => [
                    ...
                    'default' => '#29282d',
                    'rules' => 'required',
                    'assetVar' => 'item-border-color',
                ],
                'button.item.button.hover' => [
                    'label' => 'Item button hover color',
                    'type' => 'colorpicker',
                    'span' => 'left',
                    'default' => '#232227',
                    'rules' => 'required',
                    'assetVar' => 'item-button-hover-color',
                ],
                'button.item.button.border.hover' => [
                    'label' => 'Item button border hover color',
                    'type' => 'colorpicker',
                    'span' => 'left',
                    'default' => '#333235',
                    'rules' => 'required',
                    'assetVar' => 'item-button-border-hover-color',
                ],
                'button.flecha.categorias' => [
                    'label' => 'Color flecha Categorias',
                    'type' => 'colorpicker',
                    'span' => 'left',
                    'default' => '#ef1010',
                    'rules' => 'required',
                    'assetVar' => 'categories-arrow-color',
                ],
                'button.panel.background' => [
                    'label' => 'Color panel background',
                    'type' => 'colorpicker',
                    'span' => 'left',
                    'default' => '#2e2c30',
                    'rules' => 'required',
                    'assetVar' => 'panel-background-color',
                ],
                'button.titles.color' => [
                    'label' => 'Color de los Titulos',
                    'type' => 'colorpicker',
                    'span' => 'left',
                    'default' => '#ffffff',
                    'rules' => 'required',
                    'assetVar' => 'titles-color',
                ],
                'button.icons.color' => [
                    ...
                    'default' => '#ffffff',
                    'rules' => 'required',
                    'assetVar' => 'icons-color',
                ],
                'button.button.text.color' => [
                    'label' => 'Color del texto en boton',
                    'type' => 'colorpicker',
                    'span' => 'left',
                    'default' => '#ffffff',
                    'rules' => 'required',
                    'assetVar' => 'button-text-color',
                ],
            ],
        ],
        'navigation' => [
