<div class="card mb-1">
    <div class="card-body">
        <h5 class="text-white mb-0">@auth {{ sprintf(lang('igniter.user::default.text_welcome'), $customer->first_name) }} @endauth</h5>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        <h5 class="text-white font-weight-normal mb-3">@lang('igniter.user::default.text_edit_details')</h5>
        @auth
            @partial('@settings')
        @endauth
    </div>
